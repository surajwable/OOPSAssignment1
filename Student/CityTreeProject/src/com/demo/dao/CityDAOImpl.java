...
public class CityDAOImpl implements CityDAO{
	...
	public List<String> getByCity(String cname) {
		//if get(key) the it will return the values inside it
		//here the list of trees will return to the List lst in memu
	...
	public List<String> getByTree(String tname) {
		...
		//check if cities are added in a list cities
